...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 19 avr. 2025 à 10:31
...
(79, 'Farfetch', '1st Edition', 'Base Set', 'Normal', 52, '65', 'Uncommon', 'A duck Pokémon that carries a leek.'),
...
--
-- Structure de la table `user_pokemon_cards`
--

DROP TABLE IF EXISTS `user_pokemon_cards`;
CREATE TABLE IF NOT EXISTS `user_pokemon_cards` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `usr_id` int(11) NOT NULL,
  `card_id` int(11) NOT NULL,
  `username` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `usr_id` (`usr_id`,`card_id`),
  KEY `card_id` (`card_id`),
  KEY `username` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `user_pokemon_cards`
--

INSERT INTO `user_pokemon_cards` (`id`, `usr_id`, `card_id`, `username`) VALUES
(1, 1, 2, 'oui'),
(2, 2, 2, 'non'),
(3, 2, 3, 'non');
...
INSERT INTO `usr` (`id`, `usr_id`, `password`, `is_admin`) VALUES
(1, 'oui', 'oui', 1),
(2, 'non', 'non', 0);
COMMIT;
